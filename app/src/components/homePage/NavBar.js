...
export default class NavBar extends Component {
    ...
    static #modifyContentForUser (userLogged) {
        if (userLogged) {
            NavBar.#htmlContent = `
                <nav>
                    ...
                    <ul>
                        ...
                        <div class="account-buttons">
                            <li onclick="goToCart()"><i class="fa-regular fa-user"></i></li>
        ...
        return NavBar.#htmlContent
    }

    constructor (userLogged) {
        const htmlContent = NavBar.#modifyContentForUser(userLogged)
        super("header", htmlContent)    
    }
}